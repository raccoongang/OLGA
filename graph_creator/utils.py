...
class LoadTestModel(object):
	...
	def probability_to_add_course():
		return probability(0.5 * (cls.clusters['middle']['courses'][0] + cls.clusters['middle']['courses'][1])/cls.days)

	def probability_to_add_student():
		return probability(0.5 * (cls.clusters['middle']['students'][0] + cls.clusters['middle']['students'][1])/cls.days)
