...
class TestInstallationStatisticsFormsChecker(TestCase):
    ...
    def test_decorator_if_forms_are_valid(self, mock_edx_installation_form, mock_installation_statistics_form):
        """
    ...
    def test_decorator_if_forms_are_not_valid(self, mock_edx_installation_form, mock_installation_statistics_form):
        """
    ...
    def test_decorated_method_if_forms_are_valid(self, mock_edx_installation_form, mock_installation_statistics_form):
        """
